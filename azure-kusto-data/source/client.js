...
module.exports = class KustoClient {
    constructor(kcsb) {
        ...
        this.endpoints = {
            ...
            queryV1: `${this.cluster}/v1/rest/query`,
    ...
    async executeQueryV1(db, query, properties) {
        return this._execute(this.endpoints.QueryV1, ExecutionType.QueryV1, db, query, null, properties);
    }
    ...
    _getClientTimeout(executionType, properties) {
        ...
        const defaultTimeout = executionType == ExecutionType.Query || executionType == ExecutionType.queryV1 ? QUERY_TIMEOUT_IN_MILLISECS : COMMAND_TIMEOUT_IN_MILLISECS;

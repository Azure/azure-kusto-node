...
export const UpperFields: React.FunctionComponent<UpperFieldsProps> = ({config, setConfig, tableCreated}) => {
    ...
    return (
      ...
      <p style={{ marginBottom: 0 }}>
        Note: This example uses @azure/identity InteractiveBrowserCredential. The authentication app id above should be granted admin consent to Azure Data Explorer and 
      </p>
      <p style={{ marginBottom: 0, marginTop: 0 }}>
      allow the redirectUri of the url of this site {locationToPrint}, see steps <Link href="https://github.com/Azure/azure-sdk-for-js/tree/main/sdk/identity/identity/test/manual/interactive-browser-credential">here</Link>.      </p>
      {/* TODO - change link to our docs once done */}
      <p style={{ marginTop: 0 }}>Web app best practice is providing the user a login option, feeding the tokens yourself to the client via withTokenProvider builder (see JS comment)</p>

            ...
            {!fileName ? (
                ...
                >
                    ...
                    <div style={{ margin: "auto", alignItems: "center", flexDirection: "column", display: "flex" }}>
                        <Icon style={{ marginBottom: 10 }} iconName="upload" styles={{ root: { width: 42, height: 31, fontSize: 42, paddingBottom: 28 } }} />
                        <Text style={{ color: "white" }}>Drop files here</Text>
                        <Link>Drop or browse</Link>
                    </div>
                </div>
            ) : (
                <Icon style={{ marginBottom: 10 }} iconName="doc" styles={{ root: { width: 42, height: 31, fontSize: 42, paddingBottom: 28 } }} />
            )}
        </div>
    );
};

...
### Changed 
- Support Delos and Gov SG national Clouds
- Bump dependecies: axios , brace-expansion, form-data
- Support proxies that publish their own AuthMetadata

## [7.0.2] - 2025-11-25

- Bad release - skip this version

### Fixed

- Fixed CloudSettings caching to use host-based keys instead of full URL paths, improving memory efficiency and ensuring consistent cloud settings for the same cluster
...
[7.1.0]: https://github.com/Azure/azure-kusto-node/compare/v7.0.4...v7.1.0
